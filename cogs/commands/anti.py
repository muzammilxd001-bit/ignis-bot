    ...
    if option is None:
      ...
      if is_activated:
        ...
        setup_embed = discord.Embed(
          ...
          description="<:tick:1348326381611647046> | Initializing Quick Setup!",
          color=0x000000
        )
        ...
        if not ctx.guild.me.guild_permissions.administrator:
          setup_embed.description += "\n<:alert:1348340453803687966> | Setup failed: Missing **Administrator** permission."
          await setup_message.edit(embed=setup_embed)
          return

        await asyncio.sleep(1)
        setup_embed.description += "\n<:tick:1348326381611647046> | Checking Ignis's role position for optimal configuration..."
        await setup_message.edit(embed=setup_embed)

        await asyncio.sleep(1)
        setup_embed.description += "\n<:tick:1348326381611647046> | Crafting and configuring the Ignis Supreme role..."
        await setup_message.edit(embed=setup_embed)
        ...
        try:
          ...
          setup_embed.description += "\n<:alert:1348340453803687966> | Setup failed: Insufficient permissions to create role."
          await setup_message.edit(embed=setup_embed)
          return
        except discord.HTTPException as e:
          setup_embed.description += f"\n<:alert:1348340453803687966> | Setup failed: HTTPException: {e}\nCheck Guild **Audit Logs**."
          await setup_message.edit(embed=setup_embed)
          return

        await asyncio.sleep(1)
        setup_embed.description += "\n<:tick:1348326381611647046> | Ensuring precise placement of the Ignis Supreme role..."
        await setup_message.edit(embed=setup_embed)
        try:
          await ctx.guild.edit_role_positions(positions={role: 1})
        except discord.Forbidden:
          setup_embed.description += "\n<:alert:1348340453803687966> | Setup failed: Insufficient permissions to move role."
          await setup_message.edit(embed=setup_embed)
          return
        except discord.HTTPException as e:
          setup_embed.description += f"\n<:alert:1348340453803687966> | Setup failed: HTTPException: {e}."
        ...
        await asyncio.sleep(1)
        setup_embed.description += "\n<:tick:1348326381611647046> | Safeguarding your changes..."
        await setup_message.edit(embed=setup_embed)

        await asyncio.sleep(1)
        setup_embed.description += "\n<:tick:1348326381611647046> | Activating the Antinuke Modules for enhanced security...!!"
        await setup_message.edit(embed=setup_embed)
        ...
        embed = discord.Embed(
          description=f"**Security Settings For {ctx.guild.name} <:automod2:1348889859632140298>**\n\nTip: For optimal functionality of the AntiNuke Module, please ensure that my role has **Administration** permissions and is positioned at the **Top** of the roles list\n\n<:setting:1348340711862571069> __**Modules Enabled**__\n>>> <a:enabled:1349283415962157056> **Anti Ban**\n<a:enabled:1349283415962157056> **Anti Kick**\n<a:enabled:1349283415962157056> **Anti Bot**\n<a:enabled:1349283415962157056> **Anti Channel Create**\n<a:enabled:1349283415962157056> **Anti Channel Delete**\n<a:enabled:1349283415962157056> **Anti Channel Update**\n<a:enabled:1349283415962157056> **Anti Everyone/Here**\n<a:enabled:1349283415962157056> **Anti Role Create**\n<a:enabled:1349283415962157056> **Anti Role Delete**\n<a:enabled:1349283415962157056> **Anti Role Update**\n<a:enabled:1349283415962157056> **Anti Member Update**\n<a:enabled:1349283415962157056> **Anti Guild Update**\n<a:enabled:1349283415962157056> **Anti Integration**\n<a:enabled:1349283415962157056> **Anti Webhook Create**\n<a:enabled:1349283415962157056> **Anti Webhook Delete**\n<a:enabled:1349283415962157056> **Anti Webhook Update**",
          color=0x000000
        )
