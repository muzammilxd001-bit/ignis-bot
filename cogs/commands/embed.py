...
class Embed(commands.Cog):
    ...
    async def _embed(self, ctx):
        ...
        button_send = Button(label="Send Embed",  emoji="<a:Channel:1349266782078107672>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<:delete:1348340540650950816>", style=discord.ButtonStyle.danger)
