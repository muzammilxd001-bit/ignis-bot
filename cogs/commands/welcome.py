        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(thumbnail_link):
                ...
                ray = discord.Embed(
                    color=0x2b2d31,
                    description=
                    "<:tick:1348326381611647046> | Successfully updated the welcome thumbnail url .",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(image_link):
                ...
                ray = discord.Embed(
                    color=0x2b2d31,
                    description=
                    "<:tick:1348326381611647046> | Successfully updated the welcome image url .",
                    timestamp=ctx.message.created_at)
                ray.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=ray)
    ...
    async def _greet_autodel(self, ctx, *, autodelete_second):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            ray = discord.Embed(
                color=0x2b2d31,
                description=
                f"<:tick:1348326381611647046> | Successfully updated the welcome autodelete second to {autodelete_second} .\nFrom now welcome message will be deleted after {autodelete_second} .",
                timestamp=ctx.message.created_at)
            ray.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=ray)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            try:
                ...
                ray = discord.Embed(
                    color=0x2b2d31,
                    description=
                    f"<:tick:1348326381611647046> | Successfully updated the welcome message .",
                    timestamp=ctx.message.created_at)
                ray.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=ray)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["embed"] == True:
                ...
                ray = discord.Embed(
                    color=0x2b2d31,
                    description=
                    f"<:tick:1348326381611647046> | Okay, Now your embed is removed and welcome message will be a plain message .",
                    timestamp=ctx.message.created_at)
                ray.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=ray)
                ...
                ray1 = discord.Embed(
                    color=0x2b2d31,
                    description=
                    f"<:tick:1348326381611647046> | Okay, Now your embed is enabled and welcome message will be a embed message.",
                    timestamp=ctx.message.created_at)
                ray1.set_author(name=f"{ctx.author.name}",
                                   icon_url=f"{ctx.author.avatar}")
                await ctx.send(content="hey",embed=ray1)
        else:
            ray5 = discord.Embed(description="""```diff
 - You must have Administrator permission. - Your top role should be above my top role. 
```""",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["ping"] == True:
                ...
                ray = discord.Embed(
                    color=0x2b2d31,
                    description=
                    f"<:tick:1348326381611647046> | Okay, Now your embed ping is disabled and users won't get pinged upon welcome .",
                    timestamp=ctx.message.created_at)
                ray.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=ray)
            ...
            if len(chh) == 1:
                ...
                if str(channel.id) in chh:
                    ray1 = discord.Embed(
                        color=0x2b2d31,
                        description=
                        f"<:cross:1348326385386651748> | This channel is already in the welcome channels list .",
                        timestamp=ctx.message.created_at)
                    ray1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=ray1)
                    ...
                    ray4 = discord.Embed(
                        color=0x2b2d31,
                        description=
                        f"<:tick:1348326381611647046> | Successfully added {channel.mention} to welcome channel list .",
                        timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 0:
                ray = discord.Embed(
                    color=0x2b2d31,
                    description=
                    f"<:cross:1348326385386651748> | This server dont have any welcome channel setupped yet .",
                    timestamp=ctx.message.created_at)
                ray.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=ray)
                ...
                if str(channel.id) not in chh:
                    ray1 = discord.Embed(
                        color=0x2b2d31,
                        description=
                        f"<:cross:1348326385386651748> | This channel is not in the welcome channels list .",
                        timestamp=ctx.message.created_at)
                    ray1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=ray1)
                    ...
                    ray3 = discord.Embed(
                        color=0x2b2d31,
                        description=
                        f"<:tick:1348326381611647046> | Successfully removed {channel.mention} from welcome channel list .",
                        timestamp=ctx.message.created_at)
    ...
    async def welctestt(self, ctx):
        ...
        if chan == []:
            ray = discord.Embed(
                color=0x2b2d31,
                description=
                f"<:cross:1348326385386651748> | Oops, Kindly setup your welcome channel first .",
                timestamp=ctx.message.created_at)
            ray.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=ray)
            ...
            if emtog == True:
                await channn.send(emping, embed=em, delete_after=ray1)
            else:
                if emtog == False:
                    await channn.send(msg, delete_after=ray1)
    ...
    async def _reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["channel"] == []:
                embed = discord.Embed(
                    description=
                    "<:cross:1348326385386651748> | This server don't have any greet channel setuped yet .",
                    color=0x2b2d31)
                await ctx.send(embed=embed)
            else:
                ...
                ray = discord.Embed(
                    description=
                    "<:tick:1348326381611647046> | Succesfully cleared all greet config for this server .",
                    color=0x2b2d31)
                await ctx.send(embed=ray)
        else:
            ray5 = discord.Embed(
