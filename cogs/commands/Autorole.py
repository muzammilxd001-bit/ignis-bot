...
DATABASE_PATH = 'data/autorole.db'
...
class AutoRole(commands.Cog):
    ...
    async def _ar_config(self, ctx):
        ...
        if data:
            ...
            emb.add_field(name="<:member:1348326398929932388> __Humans__", value=hums, inline=False)
            emb.add_field(name="<:robot:1348340531335270420> __Bots__", value=bos, inline=False)
    ...
    async def _autorole_humans_add(self, ctx, *, role: discord.Role):
        ...
        if data:
            ...
            if role.id in humans:
                embed = discord.Embed(title="<:alert:1348340453803687966> Access Denied",
