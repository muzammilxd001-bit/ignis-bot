...
class Nightmode(commands.Cog):
    ...
    async def nightmode(self, ctx):
        ...
        nightmode_embed.add_field(
            name="Usage",
            value="<a:black_dot:1348871328320458784>`nightmode enable`\n<a:black_dot:1348871328320458784>`nightmode disable`",
            inline=False
        )
    ...
    async def enable_nightmode(self, ctx):
        if ctx.guild.member_count < 50:  
            return await ctx.send(embed=discord.Embed(title="<:cross:1348326385386651748> Access Denied",
                color=self.color,
        ...
        if not own and not check and ctx.author.id not in self.ray:
            return await ctx.send(embed=discord.Embed(title="<:cross:1348326385386651748> Access Denied",
                color=self.color,
        ...
        ) and ctx.author.id not in self.ray:
            return await ctx.send(embed=discord.Embed(title="<:cross:1348326385386651748> Access Denied",
                color=self.color,
        ...
        if not manageable_roles:
            return await ctx.send(embed=discord.Embed(title="<:cross:1348326385386651748>  Error",
                color=self.color,
        ...
        await ctx.send(embed=discord.Embed(title="<:tick:1348326381611647046> Success",
            color=self.color,
