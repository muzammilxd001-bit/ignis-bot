...
class antipinginv(Cog):
    ...
    async def on_message(self, message):
      button = Button(label="Invite Me", url =  "https://discord.com/api/oauth2/authorize?client_id=1355539303475712032&permissions=4398046511103&scope=applications.commands+bot")
      ...
      try:
        ...
        with open('data/ignore.json', 'r') as heck:
          ...
          if message.mention_everyone:
            if str(message.author.id) in wled or anti == "off" or wlroles in ray.roles:
              pass
            else:
              if punishment == "ban":
          ...
          elif message.content == Ignis or message.content == "<@1355539303475712032>":
