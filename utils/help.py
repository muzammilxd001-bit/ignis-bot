    ...
    async def callback(self, interaction: discord.Interaction):
        if self.invoker == interaction.user:
            ...
            await interaction.response.send_message(
                "<:cross:1348326385386651748> Hey it's not your session !",
                ephemeral=True,
            )


class Igniss(discord.ui.Button):
...
class Buttons(discord.ui.Button):
    ...
    def __init__(self, command, ctx, label, style: discord.ButtonStyle, args=None):
        disable = False
        if args == -1 or args == 0:
            disable = True
...
class View(discord.ui.View):
    ...
    def add_buttons(self):
        ...
        self.backB = Igniss(
            emoji="<:arrow_left:1348340563610435594>",
            style=discord.ButtonStyle.grey,
        ...
        self.nextB = Igniss(
            emoji="<:arrow_right:1348340445708816494>",
            style=discord.ButtonStyle.grey,
            command=self.to_page,
            args=+1,
            ctx=self.ctx,
        ...
        self.quitB = Igniss(
            emoji="<:delete:1348340540650950816>",
    ...
    def gen_embeds(self):
        ...
        options.append(
            discord.SelectOption(
                label="Index",
                emoji="<:home:1348326486511325256>",
                description="Show You Index",
            )
        )
        ...
        for cog in self.get_cogs():
            if "help_custom" in dir(cog):
                ...
                embed = discord.Embed(title=f"{emoji} {label}", color=0x2B2D31)
                embed.set_footer(
